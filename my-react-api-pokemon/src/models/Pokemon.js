...
export  default class Pokemon {
    ...
    constructor(id: number, pokedexId: number, generation: Generation, category: string, name: {en:string , fr:string , jp:string}, sprites: {gmax: {shiny:string , regular:string} , shiny:string, regular:string}, types: [{name:string,image:string}], stats: { hp:number,atk:number,def:number,vit:number ,spe_atk:number,spe_def:number }, resistances: [{name:string , multiplier:number}], evolution: {pre:[{name:string , condition:string , pokedexId:number}] , mega : [{orbre:string , sprites: {shiny:string , regular:string}}] , next:[{name:string , condition:string, pokedexId:number}]}, height: string, weight: string, eggGroups: object, sexe: {male:number, female:number}, catchRate: number, level100: number) {
        this._id = id;
